      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {SERVICES_LIST.slice(0, 5).map((srv, index) => {
          ...
          return (
            <div
              key={srv.id}
              className="flip-card relative h-[440px] w-full cursor-pointer select-none group"
            ...
            >
              ...
              >
                ...
                {/* ================= CARD FRONT (封面) ================= */}
                <div
                  className="flip-card-face flip-card-front absolute inset-0 w-full h-full rounded-3xl p-5 sm:p-6 flex flex-col justify-between overflow-hidden shadow-lux transition-all duration-300 group-hover:shadow-lux-lg border border-[#DFCDB4] bg-white"
                >
